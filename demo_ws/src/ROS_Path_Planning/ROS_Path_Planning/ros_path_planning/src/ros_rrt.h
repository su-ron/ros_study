...
class RRT {
    ...
    public:
        ...
        std::vector<Node> getPath(std::vector<Node> Tree, Node last_node);
        std::vector<Node> solve();
	void place_points(ros::Publisher marker_publisher, std::vector<Node> Nodes);
};
